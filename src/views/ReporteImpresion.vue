...
import CuerpoReporte from '../components/reporteimpresion/CuerpoReporte.vue';
...
import VueHtml2pdf from 'vue-html2pdf';
    export default {
        ...
        components :{ CuerpoReporte, VueHtml2pdf ,BarraDeNavegacion},
...
htmlToPdfOptions: {
    ...
    filename: 'ReporteValoracionInicial.pdf',
