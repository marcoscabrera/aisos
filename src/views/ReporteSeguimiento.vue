...
<vue-html2pdf
    ...
    >
        <section slot="pdf-content">
            <CuerpoReporteSeguimiento  name="impresiones"></CuerpoReporteSeguimiento>
...
import CuerpoReporteSeguimiento from '../components/reporteimpresion/CuerpoReporteSeguimiento.vue';
import BarraDeNavegacion from "@/components/etapas/BarraDeNavegacion.vue";
...
import VueHtml2pdf from 'vue-html2pdf';
    export default {
        ...
        components :{ CuerpoReporteSeguimiento, VueHtml2pdf ,BarraDeNavegacion},
...
htmlToPdfOptions: {
    ...
    filename: 'ReporteSeguimiento.pdf',
