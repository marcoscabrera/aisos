...
<br>B) Los datos personales proporcionados de manera voluntaria por los posibles donantes, son utilizados para darlos de alta en cualquiera de nuestros programas y a partir de ello, comenzar a recibir sus donativos de manera periódica.
<br>C) Los datos personales proporcionados por los donantes, son utilizados para el cobro de los donativos, envío de comprobantes fiscales, emisión de recibos deducibles de impuestos y, en su caso, para el cumplimiento de obligaciones legales.
<br>D) Los datos personales de nuestros donantes también son utilizados para, con su consentimiento, enviarles información relacionada a la Asociación, la causa, los programas de ayuda, los niños y niñas y otras formas de apoyar a través de correos electrónicos, correspondencia física, llamadas telefónicas, entre otros medios de contacto.
<br>Aldeas Infantiles SOS México no proporciona información de sus donantes a ninguna empresa externa para fines mercadotécnicos, publicitarios o de prospección. Los datos personales no serán utilizados para fines mercadotécnicos, publicitarios o de prospección comercial, salvo para el envío de la información relacionada con la Asociación, en términos del inciso D anterior.
En caso de que no desee que sus datos personales sean utilizados para las finalidades anteriormente descritas, usted puede negarse desde este momento o, posteriormente, manifestar su negativa mediante el envío de un correo electrónico a protecciondedatos@aldeasinfantiles.org.mx.
...
B) Dirección o domicilio<br>
C) Fecha de nacimiento<br>
D) Sexo<br>
E) Teléfono<br>
F) Correo electrónico<br>
G) Documento oficial de identificación<br>
H) Información financiera para la realización de los cargos autorizados (información contenida en tarjetas de débito o crédito)<br>

En términos de lo dispuesto por el último párrafo del artículo 8 de la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, en los casos en los que se obtenga la información financiera señalada en el inciso H anterior, se solicitará el consentimiento expreso del donante para el tratamiento de dicha información, a través del formato o boleta mediante la cual sea recabada.
De conformidad con lo anterior, en términos del presente Aviso de Privacidad, no se da tratamiento a datos personales sensibles, cuya utilización indebida pudiera afectar la esfera más íntima de su titular o cuya utilización indebida pueda dar origen a discriminación o conlleve a un riesgo grave para el titular. Los datos personales que se recaban, en términos de lo señalado anteriormente, no incluyen aspectos que pudieran revelar origen racial o étnico, estado de salud presente y futuro, información genética, creencias religiosas, filosóficas y morales, afiliación sindical, opiniones políticas o preferencia sexual.
...
R.L. de C.V. y Human Kind S.A. de C.V.<br>
Al recabar los datos, dichas empresas prestadoras de servicios actúan en nombre y representación de Aldeas Infantiles SOS México I.A.P. y se obligan a cumplir con las obligaciones de confidencialidad y de protección de datos personales en los mismos términos que dicha Organización, así como a resguardar, proteger y velar por la privacidad de los datos que el personal que trabaje en dichas empresas recabe y solamente utilizarlos para dar cumplimiento al objetivo de dichos contratos. Las empresas no podrán proporcionar, utilizar, transferir ningún tipo de datos a ningún tercero que no sea Aldeas Infantiles SOS México, I.A.P. quien los utilizará exclusivamente para las finalidades descritas en el presente Aviso de Privacidad.
Concretamente, en términos de los contratos de prestación de servicios correspondientes, los prestadores de servicios se comprometen a que no negociaran, explotaran ni utilizaran, en manera alguna, los datos recabados en representación de Aldeas Infantiles S.O.S., de los posibles donantes o donantes adquiridos durante Ia vigencia del contrato o después de su rescisión, así como que atenderá a la normativa mexicana en lo referente a las medidas de seguridad.
...
Si usted no manifiesta oposición alguna en el renglón señalado a continuación para tal efecto: no consiento que mis datos personales sean transferidos o no lo informa al responsable mediante el procedimiento establecido anteriormente citado, se entenderá que ha otorgado su consentimiento para ello. No obstante lo anterior, nos comprometemos a que la información que se transfiere a terceros y que se encuentran previstas en las excepciones que fija la ley de la materia para tal efecto, sea tratada de forma responsable, confidencial y exclusivamente por aquellas personas que requieren del conocimiento de dichos datos.
Asimismo, usted podrá manifestar la negativa de que su información sea transferida, mediante el envío de un correo electrónico a:
 ...
 <strong>Consiento que mis datos personales sean tratados para las finalidades   </strong>
    ...
    <v-row>
        <v-col>
         ...
         <v-col>
             <v-btn color="green" dark block @click="aceptar">
               Acepto
            </v-btn>
...
import apiParametros from '@/apialdeas/apiParametros.js';
    ...
    cargarAcuerdo() {
     ...
     let tiporol = this.$store.state.usuarios.usuarios_usuariologueado_rol.roles_NOMBREDELROL;
    if (tiporol == "SUPERADMIN"){
        this.$store.dispatch("actions_uuivars_puedever_configuracion",true);
    }
    //this.$store.dispatch("actions_uuivars_puedever_configuracion",true);
