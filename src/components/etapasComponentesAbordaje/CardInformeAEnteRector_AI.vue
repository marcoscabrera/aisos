        ...
        <v-card-text>
          <v-row>
            <v-col cols="12" xs="12" sm="4" md="4">
             <v-select
                :value="this.$store.state.abordaje.abordaje_informaenterector"
             ...
             <!-- aqui va fileupload
              ...
              -->
                <uploadFile4 v-if="verCombo" 
                 :archivoId ="this.$store.state.abordaje.abordaje_docto_informaenterector"
                 action_a_Ejecutar ="action_abordaje_docto_informaenterector">
    ...
    export default {
      ...
      methods : {
         asignarValor(event){
            ...
            this.$store.dispatch("action_abordaje_informaenterector", event);
         }
      }
